...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> supermarketNotExists(SupermarketNotFoundException supermarketNotFoundException) {
    ...
    public ResponseEntity<Object> supermarketNotExists(SupermarketAlreadyExists supermarketAlreadyExists) {
        return new ResponseEntity<>(supermarketAlreadyExists.getMessage(), HttpStatus.NOT_FOUND);
    }
